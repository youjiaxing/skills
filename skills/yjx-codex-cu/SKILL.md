---
name: yjx-codex-cu
description: Delegate a real-GUI check to Codex CLI Computer Use.
...
The user invoked this skill for the current task. Loading the skill does not start a test, and its scope expires with the task.
